...
/**
 * A simple {@link com.eric.come.glide.load.Transformation} for transforming {@link
 * Bitmap}s that abstracts away dealing with {@link
 * com.eric.come.glide.load.engine.Resource} objects for subclasses.
 *
 ...
 *     private static final String ID = "com.eric.come.glide.transformations.FillSpace";
...
public abstract class BitmapTransformation implements Transformation<Bitmap> {
   ...
   * com.eric.come.glide.request.target.Target#SIZE_ORIGINAL}, this class converts them to be the
   * size of the Bitmap we're going to transform before calling this method.
   *
   * @param pool A {@link com.eric.come.glide.load.engine.bitmap_recycle.BitmapPool} that can be used

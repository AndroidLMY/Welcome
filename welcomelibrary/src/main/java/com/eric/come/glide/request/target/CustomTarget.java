 ...
 * com.eric.come.glide.RequestBuilder#into(ImageView)}, a subclass of {@link ImageViewTarget}, or
...
public abstract class CustomTarget<T> implements Target<T> {
   ...
   * {@link com.eric.come.glide.request.RequestOptions#override(int)}. In all other cases, prefer
   ...
   * com.eric.come.glide.request.RequestOptions#override(int)} in the request).
   *

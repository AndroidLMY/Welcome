 ...
 * differ depending on the {@link com.eric.come.glide.load.ResourceDecoder} using the strategy and
 ...
 * com.eric.come.glide.load.Transformation} either instead or in addition to a {@code
 * DownsampleStrategy}.
 *
 * <p>Some differences between versions of Android and {@link
 * com.eric.come.glide.load.ResourceDecoder}s are listed below, but the list is not comprehensive
 ...
 * is supported. To preserve the potential for a {@link com.eric.come.glide.load.Transformation} to
...
public abstract class DownsampleStrategy {
  ...
  public static final Option<DownsampleStrategy> OPTION =
      Option.memory(
          "com.eric.come.glide.load.resource.bitmap.Downsampler.DownsampleStrategy", DEFAULT);

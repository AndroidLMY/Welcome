...
public abstract class DiskCacheStrategy {
   ...
   * com.eric.come.glide.load.data.DataFetcher} and the {@link
   * com.eric.come.glide.load.EncodeStrategy} of the {@link com.eric.come.glide.load.ResourceEncoder}
   * (if an {@link com.eric.come.glide.load.ResourceEncoder} is available).
   */
   ...
   *     com.eric.come.glide.load.ResourceEncoder} will use to encode the resource.
   */

...
/** A request that loads a resource for an {@link com.eric.come.glide.request.target.Target}. */
public interface Request {
   ...
   * com.eric.come.glide.request.target.Target}s (for example). Using a similar but different method

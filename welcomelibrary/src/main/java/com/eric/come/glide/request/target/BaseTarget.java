package com.eric.come.glide.request.target;
...
/**
 * A base {@link Target} for loading {@link com.eric.come.glide.load.engine.Resource}s that provides
 ...
 * {@link com.eric.come.glide.load.engine.Resource} loaded into it using {@link
 * com.eric.come.glide.RequestManager#clear(Target)}.
 *
 * <p>For loading {@link com.eric.come.glide.load.engine.Resource}s into {@link android.view.View}s,
 * {@link com.eric.come.glide.request.target.ViewTarget} or {@link
 * com.eric.come.glide.request.target.ImageViewTarget} are preferable.
 *

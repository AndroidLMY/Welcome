 ...
 * com.eric.come.glide.RequestManager} that can be used to start, stop and manage Glide requests
 * started for targets the fragment or activity this fragment is a child of.
 *
 * @see com.eric.come.glide.manager.SupportRequestManagerFragment
 * @see com.eric.come.glide.manager.RequestManagerRetriever
 * @see com.eric.come.glide.RequestManager
 */
...
public class RequestManagerFragment extends Fragment {
  ...
  /**
   * Sets the current {@link com.eric.come.glide.RequestManager}.
   *
  ...
  /** Returns the current {@link com.eric.come.glide.RequestManager} or null if none exists. */
  @Nullable

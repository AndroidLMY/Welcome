...
import com.eric.come.glide.load.data.HttpUrlFetcher;
import com.eric.come.glide.load.model.GlideUrl;
import com.eric.come.glide.load.model.ModelCache;
...
/**
 * An {@link com.eric.come.glide.load.model.ModelLoader} for translating {@link
 * com.eric.come.glide.load.model.GlideUrl} (http/https URLS) into {@link InputStream} data.
 */
// Public API.
...
public class HttpGlideUrlLoader implements ModelLoader<GlideUrl, InputStream> {
  ...
  public static final Option<Integer> TIMEOUT =
      Option.memory("com.eric.come.glide.load.model.stream.HttpGlideUrlLoader.Timeout", 2500);

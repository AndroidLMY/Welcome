...
import com.eric.come.glide.load.engine.DiskCacheStrategy;
import com.eric.come.glide.request.BaseRequestOptions;
import com.eric.come.glide.request.ErrorRequestCoordinator;
import com.eric.come.glide.request.FutureTarget;
import com.eric.come.glide.request.Request;
import com.eric.come.glide.request.RequestCoordinator;
import com.eric.come.glide.request.RequestFutureTarget;
import com.eric.come.glide.request.RequestListener;
import com.eric.come.glide.request.RequestOptions;
import com.eric.come.glide.request.SingleRequest;
import com.eric.come.glide.request.ThumbnailRequestCoordinator;
import com.eric.come.glide.request.target.PreloadTarget;
import com.eric.come.glide.request.target.Target;
import com.eric.come.glide.request.target.ViewTarget;
import com.eric.come.glide.signature.AndroidResourceSignature;
import com.eric.come.glide.util.Executors;
...
import static com.eric.come.glide.request.RequestOptions.diskCacheStrategyOf;
import static com.eric.come.glide.request.RequestOptions.signatureOf;
import static com.eric.come.glide.request.RequestOptions.skipMemoryCacheOf;

/**
 * A generic class that can handle setting options and staring loads for generic resource types.
 *
 * @param <TranscodeType> The type of resource that will be delivered to the {@link
 *     com.eric.come.glide.request.target.Target}.
 */
// Public API.
...
public class RequestBuilder<TranscodeType> extends BaseRequestOptions<RequestBuilder<TranscodeType>>
   ...
   * com.eric.come.glide.load.model.ModelLoader}, {@link com.eric.come.glide.load.ResourceDecoder},
   * and {@link com.eric.come.glide.load.Transformation}s. However, {@link
   * com.eric.come.glide.request.RequestOptions#placeholder(int)} and {@link
   * com.eric.come.glide.request.RequestOptions#error(int)}, and {@link #listener(RequestListener)}
   ...
   * by default, consider registering a custom {@link com.eric.come.glide.load.model.ModelLoader} or
   * {@link com.eric.come.glide.load.ResourceDecoder} instead of using this method.
   *
   ...
   * com.eric.come.glide.load.model.ModelLoader} or {@link com.eric.come.glide.load.ResourceDecoder}
   ...
   * com.eric.come.glide.request.RequestOptions#signature(com.eric.come.glide.load.Key)} to mixin a
   ...
   * com.eric.come.glide.load.engine.DiskCacheStrategy#NONE} and/or {@link
   * com.eric.come.glide.request.RequestOptions#skipMemoryCache(boolean)} may be appropriate.
   *
   * @see #load(Object)
   * @param string A file path, or a uri or url handled by {@link
   *     com.eric.come.glide.load.model.UriLoader}.
   */
  @NonNull
  @Override
  @CheckResult
   ...
   * com.eric.come.glide.load.model.ModelLoaderFactory} currently registered or {@link Integer} to
   * load the image represented by the given {@link Integer} resource id. Defaults to {@link
   * com.eric.come.glide.load.model.ResourceLoader} to load resource id models.
   *
   ...
   * consider using {@link com.eric.come.glide.load.engine.DiskCacheStrategy#NONE} via {@link
   * RequestOptions#diskCacheStrategy(com.eric.come.glide.load.engine.DiskCacheStrategy)} during
   * development, and re-enabling the default {@link
   * com.eric.come.glide.load.engine.DiskCacheStrategy#RESOURCE} for release builds.
   *
   ...
   * com.eric.come.glide.load.Transformation}s to these {@link Drawable}s by either extracting the
   ...
   * transformed (other than {@link com.eric.come.glide.load.resource.gif.GifDrawable}). To avoid
   ...
   * method, especially in conjunction with {@link com.eric.come.glide.load.Transformation}s with
   * caution for non-{@link Bitmap} {@link Drawable}s.
   *
   * @see #load(Integer)
   * @see com.eric.come.glide.signature.AndroidResourceSignature
   */
  @NonNull
  @CheckResult
  @Override
   ...
   * @return The {@link com.eric.come.glide.request.target.Target} used to wrap the given {@link
   *     ImageView}.
   */
  @NonNull
   ...
   *     overridden by {@link com.eric.come.glide.request.RequestOptions#override(int, int)} if
   *     previously called.
   ...
   *     RequestManager#clear(Target)}.
   * @see com.eric.come.glide.ListPreloader
   */
  @NonNull

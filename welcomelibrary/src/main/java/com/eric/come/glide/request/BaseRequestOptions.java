package com.eric.come.glide.request;
...
import com.eric.come.glide.load.MultiTransformation;
...
import com.eric.come.glide.load.resource.bitmap.CenterCrop;
import com.eric.come.glide.load.resource.bitmap.CenterInside;
import com.eric.come.glide.load.resource.bitmap.CircleCrop;
import com.eric.come.glide.load.resource.bitmap.DownsampleStrategy;
import com.eric.come.glide.load.resource.bitmap.Downsampler;
import com.eric.come.glide.load.resource.bitmap.DrawableTransformation;
import com.eric.come.glide.load.resource.bitmap.FitCenter;
import com.eric.come.glide.load.resource.bitmap.VideoDecoder;
import com.eric.come.glide.load.resource.gif.GifDrawable;
import com.eric.come.glide.load.resource.gif.GifDrawableTransformation;
import com.eric.come.glide.load.resource.gif.GifOptions;
import com.eric.come.glide.signature.EmptySignature;
import com.eric.come.glide.util.CachedHashCodeArrayMap;
 ...
 * com.eric.come.glide.RequestBuilder}.
 *
...
public abstract class BaseRequestOptions<T extends BaseRequestOptions<T>> implements Cloneable {
  ...
  /**
   * Applies a multiplier to the {@link com.eric.come.glide.request.target.Target}'s size before
   ...
   *     com.eric.come.glide.request.target.Target}'s dimensions when loading the resource.
   ...
   * com.eric.come.glide.RequestBuilder#load(Object)} is {@code null}.
   *
  ...
  /**
   * Overrides the {@link com.eric.come.glide.request.target.Target}'s width and height with the
   ...
   * @return This request builder.
   * @see com.eric.come.glide.signature.ObjectKey
   */
  @NonNull
  @CheckResult
   ...
   * com.eric.come.glide.load.resource.bitmap.BitmapEncoder#COMPRESSION_FORMAT}.
   */
  @NonNull
  @CheckResult
   ...
   * com.eric.come.glide.load.resource.bitmap.DownsampleStrategy.CenterOutside} can safely use {@link
   ...
   * com.eric.come.glide.load.model.stream.HttpGlideUrlLoader}. If you use any other networking
   * library including Glide's Volley or OkHttp integration libraries, this option will be ignored.
   *
   * @see com.eric.come.glide.load.model.stream.HttpGlideUrlLoader#TIMEOUT
  ...
  /**
   * Applies {@link com.eric.come.glide.load.resource.bitmap.CenterCrop} to all default types, and
  ...
  /**
   * Applies {@link com.eric.come.glide.load.resource.bitmap.CenterInside} to all default types,
   ...
   * com.eric.come.glide.load.resource.gif.GifDrawable}) and throws an exception if asked to
   ...
   * Applies the given {@link Transformation} for {@link Bitmap Bitmaps} to the default types
   * ({@link Bitmap}, {@link BitmapDrawable}, and {@link
   * com.eric.come.glide.load.resource.gif.GifDrawable}) and ignores unknown types.
   *
   * <p>This will override previous calls to {@link #dontTransform()}.
   *
   * @param transformation Any {@link Transformation} for {@link Bitmap}s.
   ...
   * com.eric.come.glide.TransitionOptions#dontTransition()}
   */
  // Guaranteed to modify the current object by the isAutoCloneEnabledCheck.
  @SuppressWarnings("CheckResult")
  @NonNull

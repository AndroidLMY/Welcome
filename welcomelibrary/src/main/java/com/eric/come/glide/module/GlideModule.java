 ...
 * com.eric.come.glide.GlideBuilder} and registering {@link com.eric.come.glide.load.model.ModelLoader
 * ModelLoaders}.
 *
 ...
 *       Registry#prepend(Class, Class, com.eric.come.glide.load.ResourceDecoder)} for each {@link
 *       com.eric.come.glide.load.model.ModelLoader} you'd like to register:
 *       <pre>
 *                  <code>
 ...
 *       <pre>{@code
 * -keepnames class * com.eric.come.glide.samples.flickr.FlickrGlideModule
 * }</pre>
 ...
 *       <pre>{@code
 * <meta-data
 *     android:name="com.eric.come.glide.samples.flickr.FlickrGlideModule"

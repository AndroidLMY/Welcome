...
public abstract class ExperimentalRequestListener<ResourceT> implements RequestListener<ResourceT> {
   ...
   *     cache key provided by a {@link com.eric.come.glide.load.model.ModelLoader} via {@link
   *     com.eric.come.glide.load.model.ModelLoader.LoadData#alternateKeys}. Valid only if {@code

...
/**
 * A class that allows {@link com.eric.come.glide.load.resource.transcode.ResourceTranscoder}s to be
...
public class TranscoderRegistry {
  ...
  /**
   * Registers the given {@link com.eric.come.glide.load.resource.transcode.ResourceTranscoder} using
   ...
   * com.eric.come.glide.load.resource.transcode.ResourceTranscoder} for the given classes.
   *

...
import com.eric.come.glide.load.data.BufferedOutputStream;
...
import com.eric.come.glide.util.pool.GlideTrace;
...
/**
 * An {@link com.eric.come.glide.load.ResourceEncoder} that writes {@link Bitmap}s
...
public class BitmapEncoder implements ResourceEncoder<Bitmap> {
  ...
  public static final Option<Integer> COMPRESSION_QUALITY =
      Option.memory("com.eric.come.glide.load.resource.bitmap.BitmapEncoder.CompressionQuality", 90);
  ...
  public static final Option<Bitmap.CompressFormat> COMPRESSION_FORMAT =
      Option.memory("com.eric.come.glide.load.resource.bitmap.BitmapEncoder.CompressionFormat");

...
public interface Transformation<T> extends Key {
   ...
   * com.eric.come.glide.load.engine.DiskCacheStrategy#NONE} or make sure {@link
   ...
   *     com.eric.come.glide.request.target.Target#SIZE_ORIGINAL} to indicate the original resource
   *     width.

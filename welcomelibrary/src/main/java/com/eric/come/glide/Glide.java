...
import com.eric.come.glide.GlideBuilder.EnableImageDecoderForBitmaps;
...
import com.eric.come.glide.load.data.InputStreamRewinder;
import com.eric.come.glide.load.data.ParcelFileDescriptorRewinder;
import com.eric.come.glide.load.engine.Engine;
...
import com.eric.come.glide.load.engine.cache.MemoryCache;
import com.eric.come.glide.load.engine.prefill.BitmapPreFiller;
import com.eric.come.glide.load.engine.prefill.PreFillType;
import com.eric.come.glide.load.engine.prefill.PreFillType.Builder;
import com.eric.come.glide.load.model.AssetUriLoader;
import com.eric.come.glide.load.model.ByteArrayLoader;
import com.eric.come.glide.load.model.ByteBufferEncoder;
import com.eric.come.glide.load.model.ByteBufferFileLoader;
import com.eric.come.glide.load.model.DataUrlLoader;
import com.eric.come.glide.load.model.FileLoader;
import com.eric.come.glide.load.model.GlideUrl;
import com.eric.come.glide.load.model.MediaStoreFileLoader;
import com.eric.come.glide.load.model.ResourceLoader;
import com.eric.come.glide.load.model.StreamEncoder;
import com.eric.come.glide.load.model.StringLoader;
import com.eric.come.glide.load.model.UnitModelLoader;
import com.eric.come.glide.load.model.UriLoader;
import com.eric.come.glide.load.model.UrlUriLoader;
import com.eric.come.glide.load.model.stream.HttpGlideUrlLoader;
import com.eric.come.glide.load.model.stream.MediaStoreImageThumbLoader;
import com.eric.come.glide.load.model.stream.MediaStoreVideoThumbLoader;
import com.eric.come.glide.load.model.stream.QMediaStoreUriLoader;
import com.eric.come.glide.load.model.stream.UrlLoader;
import com.eric.come.glide.load.resource.bitmap.BitmapDrawableDecoder;
import com.eric.come.glide.load.resource.bitmap.BitmapDrawableEncoder;
import com.eric.come.glide.load.resource.bitmap.BitmapEncoder;
import com.eric.come.glide.load.resource.bitmap.ByteBufferBitmapDecoder;
import com.eric.come.glide.load.resource.bitmap.ByteBufferBitmapImageDecoderResourceDecoder;
import com.eric.come.glide.load.resource.bitmap.DefaultImageHeaderParser;
import com.eric.come.glide.load.resource.bitmap.Downsampler;
import com.eric.come.glide.load.resource.bitmap.ExifInterfaceImageHeaderParser;
import com.eric.come.glide.load.resource.bitmap.HardwareConfigState;
import com.eric.come.glide.load.resource.bitmap.InputStreamBitmapImageDecoderResourceDecoder;
import com.eric.come.glide.load.resource.bitmap.ParcelFileDescriptorBitmapDecoder;
import com.eric.come.glide.load.resource.bitmap.ResourceBitmapDecoder;
import com.eric.come.glide.load.resource.bitmap.StreamBitmapDecoder;
import com.eric.come.glide.load.resource.bitmap.UnitBitmapDecoder;
import com.eric.come.glide.load.resource.bitmap.VideoDecoder;
import com.eric.come.glide.load.resource.bytes.ByteBufferRewinder;
import com.eric.come.glide.load.resource.drawable.ResourceDrawableDecoder;
import com.eric.come.glide.load.resource.drawable.UnitDrawableDecoder;
import com.eric.come.glide.load.resource.file.FileDecoder;
import com.eric.come.glide.load.resource.gif.ByteBufferGifDecoder;
import com.eric.come.glide.load.resource.gif.GifDrawable;
import com.eric.come.glide.load.resource.gif.GifDrawableEncoder;
import com.eric.come.glide.load.resource.gif.GifFrameResourceDecoder;
import com.eric.come.glide.load.resource.gif.StreamGifDecoder;
import com.eric.come.glide.load.resource.transcode.BitmapBytesTranscoder;
import com.eric.come.glide.load.resource.transcode.BitmapDrawableTranscoder;
import com.eric.come.glide.load.resource.transcode.DrawableBytesTranscoder;
import com.eric.come.glide.load.resource.transcode.GifDrawableBytesTranscoder;
import com.eric.come.glide.manager.ConnectivityMonitorFactory;
import com.eric.come.glide.manager.RequestManagerRetriever;
import com.eric.come.glide.module.ManifestParser;
import com.eric.come.glide.request.RequestListener;
import com.eric.come.glide.request.RequestOptions;
import com.eric.come.glide.request.target.ImageViewTargetFactory;
import com.eric.come.glide.request.target.Target;
 ...
 * com.eric.come.glide.load.engine.cache.DiskCache} and {@link MemoryCache}.
 */
public class Glide implements ComponentCallbacks2 {
  ...
  private static void initializeGlide(
    ...
    List<com.eric.come.glide.module.GlideModule> manifestModules = Collections.emptyList();
    ...
    if (annotationGeneratedModule != null
      ...
      Iterator<com.eric.come.glide.module.GlideModule> iterator = manifestModules.iterator();
      while (iterator.hasNext()) {
        com.eric.come.glide.module.GlideModule current = iterator.next();
    ...
    if (Log.isLoggable(TAG, Log.DEBUG)) {
      for (com.eric.come.glide.module.GlideModule glideModule : manifestModules) {
    ...
    for (com.eric.come.glide.module.GlideModule module : manifestModules) {
    ...
    try {
      Class<GeneratedAppGlideModule> clazz =
          (Class<GeneratedAppGlideModule>)
              Class.forName("com.eric.come.glide.GeneratedAppGlideModuleImpl");
      result =
  ...
  /**
   * Returns the {@link com.eric.come.glide.load.engine.bitmap_recycle.BitmapPool} used to
   ...
   * com.eric.come.glide.load.ResourceDecoder}s and {@link com.eric.come.glide.load.Transformation}s.

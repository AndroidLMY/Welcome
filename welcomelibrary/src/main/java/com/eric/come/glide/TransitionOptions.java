...
import com.eric.come.glide.request.transition.NoTransition;
import com.eric.come.glide.request.transition.TransitionFactory;
import com.eric.come.glide.request.transition.ViewAnimationFactory;
import com.eric.come.glide.request.transition.ViewPropertyAnimationFactory;
import com.eric.come.glide.request.transition.ViewPropertyTransition;
...
public abstract class TransitionOptions<
   ...
   *
   * @param animator The {@link com.eric.come.glide.request.transition.ViewPropertyTransition
   *     .Animator} to run.
   * @return This request builder.
   */
  @NonNull
   ...
   * com.eric.come.glide.request.transition.Transition} for each request started with these {@code
   * TransitionOptions}.
   *
   * @return This request builder.
   */

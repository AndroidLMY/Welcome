...
/**
 * Generates a series of {@link com.eric.come.glide.load.data.DataFetcher DataFetchers} using
 * registered {@link com.eric.come.glide.load.model.ModelLoader ModelLoaders} and a model.
 */
interface DataFetcherGenerator {
  /**
   * Called when the generator has finished loading data from a {@link
   * com.eric.come.glide.load.data.DataFetcher}.
   */
  ...
  /**
   * Attempts to a single new {@link com.eric.come.glide.load.data.DataFetcher} and returns true if a
   * {@link com.eric.come.glide.load.data.DataFetcher} was started, and false otherwise.
   */
  boolean startNext();

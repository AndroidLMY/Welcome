...
import com.eric.come.glide.load.ImageHeaderParser.ImageType;
import com.eric.come.glide.load.Option;
import com.eric.come.glide.load.Options;
import com.eric.come.glide.load.PreferredColorSpace;
...
import com.eric.come.glide.load.resource.bitmap.DownsampleStrategy.SampleSizeRounding;
import com.eric.come.glide.request.RequestOptions;
import com.eric.come.glide.request.target.Target;
import com.eric.come.glide.util.LogTime;
...
public final class Downsampler {
  ...
  public static final Option<DecodeFormat> DECODE_FORMAT =
      Option.memory(
          "com.eric.come.glide.load.resource.bitmap.Downsampler.DecodeFormat", DecodeFormat.DEFAULT);
  ...
  public static final Option<PreferredColorSpace> PREFERRED_COLOR_SPACE =
      Option.memory(
          "com.eric.come.glide.load.resource.bitmap.Downsampler.PreferredColorSpace",
          PreferredColorSpace.SRGB);
  /**
   * Indicates the {@link com.eric.come.glide.load.resource.bitmap.DownsampleStrategy} option that
  ...
  public static final Option<Boolean> FIX_BITMAP_SIZE_TO_REQUESTED_DIMENSIONS =
      Option.memory("com.eric.come.glide.load.resource.bitmap.Downsampler.FixBitmapSize", false);
   ...
   * com.eric.come.glide.GlideBuilder#setDefaultRequestOptions(RequestOptions)}.
   *
   * <p>This option is ignored unless we're on Android O+.
   */
  public static final Option<Boolean> ALLOW_HARDWARE_CONFIG =
      Option.memory(
          "com.eric.come.glide.load.resource.bitmap.Downsampler.AllowHardwareDecode", false);
   ...
   * provided {@link com.eric.come.glide.load.resource.bitmap.DownsampleStrategy} option.
   *
   ...
   * com.eric.come.glide.load.engine.bitmap_recycle.BitmapPool} whose dimensions exactly match those

...
public interface RequestListener<R> {
   ...
   * use {@link com.eric.come.glide.RequestBuilder#error(RequestBuilder)} instead.
   *
   ...
   * Target#onResourceReady(Object, com.eric.come.glide.request.transition.Transition)}.
   *
   * <p>For threading guarantees, see the class comment.
   *

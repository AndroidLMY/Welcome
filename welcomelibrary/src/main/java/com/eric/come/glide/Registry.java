...
import com.eric.come.glide.load.data.DataRewinder;
import com.eric.come.glide.load.data.DataRewinderRegistry;
import com.eric.come.glide.load.engine.DecodePath;
import com.eric.come.glide.load.engine.LoadPath;
...
import com.eric.come.glide.load.model.ModelLoaderRegistry;
import com.eric.come.glide.load.resource.transcode.ResourceTranscoder;
import com.eric.come.glide.load.resource.transcode.TranscoderRegistry;
import com.eric.come.glide.provider.EncoderRegistry;
import com.eric.come.glide.provider.ImageHeaderParserRegistry;
import com.eric.come.glide.provider.LoadPathCache;
import com.eric.come.glide.provider.ModelToResourceClassCache;
import com.eric.come.glide.provider.ResourceDecoderRegistry;
import com.eric.come.glide.provider.ResourceEncoderRegistry;
import com.eric.come.glide.util.pool.FactoryPools;
...
public class Registry {
   ...
   *     {@link com.eric.come.glide.load.resource.gif.GifDrawable} etc).
   ...
   * com.eric.come.glide.load.resource.gif.GifDrawable} and any other subclass.
   *
  ...
  /**
   * Registers a new {@link com.eric.come.glide.load.data.DataRewinder.Factory} to handle a
  ...
  /**
   * Thrown when no {@link com.eric.come.glide.load.model.ModelLoader} is registered for a given
   * model class.
   */

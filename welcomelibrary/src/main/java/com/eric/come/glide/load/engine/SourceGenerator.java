...
import com.eric.come.glide.load.data.DataFetcher.DataCallback;
import com.eric.come.glide.load.model.ModelLoader;
import com.eric.come.glide.load.model.ModelLoader.LoadData;
...
/**
 * Generates {@link com.eric.come.glide.load.data.DataFetcher DataFetchers} from original source data
 * using registered {@link com.eric.come.glide.load.model.ModelLoader ModelLoaders} and the model

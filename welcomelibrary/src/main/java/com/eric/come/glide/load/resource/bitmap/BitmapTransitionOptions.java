...
import com.eric.come.glide.TransitionOptions;
import com.eric.come.glide.request.transition.BitmapTransitionFactory;
import com.eric.come.glide.request.transition.DrawableCrossFadeFactory;
...
public final class BitmapTransitionOptions
   ...
   *
   * @see com.eric.come.glide.GenericTransitionOptions#with(TransitionFactory)
   */
  @NonNull
   ...
   * @see com.eric.come.glide.request.transition.DrawableCrossFadeFactory.Builder
   */
  @NonNull
